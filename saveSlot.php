...
<head>
    ...
    <link rel="stylesheet" href="saveSlot.css" />
...
<h2 class="my-3 text-secondary">Proceed For Payment</h2>
    <?php
        if (isset($_POST['check'])) {
            include "./connection.php";
            $_SESSION['day'] = $_POST['taskoption'];
            $_SESSION['time'] = $_POST['timeoption'];
            $totalPrice = $_POST['totalPay'];
            ?>
            <div id="paypalPay"></div>

             <script src="https://www.paypal.com/sdk/js?client-id=AWb2PeBj7uIXi8AphicoMN3VR_JUEgQk2DDyak7eYQ5MCyC0eYRCtqidnKAc1eVNcfzr3pQeegXiZd1B&disable-funding=credit,card" ></script>
    <script>
        paypal.Buttons({
            ...
            onApprove:function(data,actions){
                return actions.order.capture().then(function(details) {
                    <?php $_SESSION['approved'] = "approved"; ?>
                    window.location.href = 'http://localhost/ecommerce/paymentSuccess.php';
                })
            } 
        }).render("#paypalPay");
    </script>
